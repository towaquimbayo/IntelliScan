...
const forgotPasswordEndpointNotFound = "Forgot password endpoint not found. Please try again.";
const resetPasswordEndpointNotFound = "Reset password endpoint not found. Please try again.";
const fetchUsersEndpointNotFound = "Fetch users endpoint not found. Please try again.";
const deleteUserEndpointNotFound = "Delete user endpoint not found. Please try again.";
const editUserEndpointNotFound = "Edit user endpoint not found. Please try again.";
...
const emailExistsError = "An account with this email already exists. Please try again.";
...
const samePasswordError = "New password cannot be the same as the old password. Please try again.";
...
const filesizeExceeded = "File size too large. Please upload a file less than 2MB.";
const llmApiPdfConvertError = "Failed to extract text from PDF.";
const llmApiModelResponseError = "Failed to get model response based on prompt.";
exports.messages = {
    noRouteExists,
    noAccessTokenFound,
    accessTokenDenied,
